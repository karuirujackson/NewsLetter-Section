    ...
    <section className='bg-[#0A6847] h-screen'>
        <div className="flex flex-col gap-8 px-4 py-12">
            <div className="flex flex-col gap-3">
                <h3 className="text-3xl leading-9 font-extrabold tracking-tight text-[#ffff]">Sign Up for our NewsLetter</h3>
            ...
            <div className="flex flex-col gap-3">
                ...
                <p className="text-sm leading-5 font-normal text-[#D1D5DB]">We care about the protection of your data. Read our <span className="underline">Privacy Policy.</span></p>
            </div>
        </div>
    </section>
  )
